...
(2026-08-27), the Rock 5B+ Type-C dual-role-power PDO declaration, and `0029`
(2026-08-27), the Rock 5B+ board-target Try.SRC preference.
...
The series has twenty-four members. `0004` is a deliberate ordinal gap — upstream never
