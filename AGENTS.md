...
| Historical board qualification evidence and its exact base | [`docs/BOARD-QUALIFICATION.md`](docs/BOARD-QUALIFICATION.md) |
...
useful history; [`retired/REGISTRY.md`](retired/REGISTRY.md) maps every ordinal to
